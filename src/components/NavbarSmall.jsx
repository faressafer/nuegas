    ...
    <div className="bg-white  flex justify-between p-4">
      <div className="flex gap-2 w-full">
        ...
        <div className="space-y-1">
          <p className="text-[#141522]  font-semibold">Angelie Crison</p>
          <div className="flex items-center gap-1">
            ...
            <p className="text-[#141522] font-medium text-[12px] tracking-[-0.24px]">
              Online
            </p>
          </div>
        </div>
      ...
      <div className="flex gap-4">
        <div className="w-[52px] h-[52px] flex items-center justify-center rounded-full border border-[#F5F5F7]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
