    ...
    <div className="">
      ...
      <div className=" p-4">
        ...
        <Link to="Settings" onClick={() => handleActive ("Settings")}>
          <div
            className={`brder p-4 flex gap-4 rounded-[10px] mb-4 w-full h-full ${
